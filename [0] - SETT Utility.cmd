...
@echo off
::SETT UTILITY | Performance Utility Program
...
echo Loading ...
:: Refreshing settUtility folder
md C:\settUtility > nul
del /s /q C:\settUtility 
cls 
...
:rON
chcp 437 >nul 2>&1
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'SETT Restore Point' -RestorePointType 'MODIFY_SETTINGS'" 
chcp 65001 >nul 2>&1
echo.
echo.
echo.
...
if exist "C:\settUtility\1_ProcessLasso\ProcessLassoSetup.exe" (
    ...
    curl -g -k -L -# -o "C:\settUtility\1_ProcessLasso\ProcessLassoSetup.exe" "https://bitsum.com/files/processlassosetup64.exe"
)
...
echo.
echo.        %b% ══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
echo.           %W% Resources missing, Make sure you are running the newest version. If you are, than make sure you ran it as administrator
echo.        %b% ══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
echo.
echo.                                                     
echo.
...
echo.
echo.                                                   %b%╔═════════════════════════════════╗
echo.                                                   %b%║     PRESS ANY KEY TO EXIT... %b%║
echo.                                                   %b%╚═════════════════════════════════╝                                                       
pause > nul
cls
...
echo.                                                                                                                                                                                                             
echo.                                                                                                                                                    
echo.                                           %p%[1]%w% Windows                 %p%[2]%w% Network              %p%[3]%w% Power Tweaks                  
echo.                                                                                                                                                    
echo.                                           %p%[4]%w% Prioirty Tweaks         %p%[5]%w% General Tweaks       %p%[6]%w% BCDedit                       
echo.                                                                                                                                                    
echo.                                           %p%[7]%w% Visual                  %p%[8]%w% Storage              %p%[9]%w% Usb Tweaks                    
echo.                                                                                                                                                    
echo.                                           %p%[10]%w% Fix Corrupted Files    %p%[11]%w% Ram Tweaks          %p%[12]%w% Full Screen Optimization     
echo.                                                                                                                                                    
echo.                                           %p%[13]%w% Gpu Tweaks             %p%[14]%w% Bios Tweaks         %p%[15]%w% Cpu Tweaks                   
echo.                                                                                                                                                    
echo.                                           %p%[16]%w% Mouse and Keyboard     %p%[17]%w% Clean               %p%[18]%w% DirectX Tweaks               
echo.                                                                                                                                                    
echo.                                           %p%[19]%w% Additonal Tweaks                                %p%[20]%w% Debloat                      
echo.                                                                                                                                                    
echo.                                                                         %p%[F]%w% Reverts/fixes                                                    
echo.                                                                                                                                                    
echo.                                                                                                                                                    
echo.                                           %p%%w%                            %p%[X]%w% Exit      %p%%w%                                             
echo.                                                                                                                                                    
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
echo.                                                                                                                                                    
echo.                                                              %p%[S]%w% Use a restore point (revert all tweaks)                                     
echo.                                                                                                                                                    
echo.       %b%╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
echo.
echo.
...
echo.
echo.
echo.                                         %p%[1]%w% Increase CPU                       %p%[2]%w% Revert CPU Config
echo.
echo.                                         %p%[3]%w% Intel CPU Tweaks                   %p%[4]%w% AMD Cpu Tweaks
echo.
echo.
...
if /i %input% == 3 goto c17
if /i %input% == 4 goto c18
if /i %input% == X cls & goto menu
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "MaximumPerformancePercent" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "PERFBOOSTMODE" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "AllowPepPerfStates" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubDelay" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubInterval" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubPower" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubThreshold" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubValue" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubValueEnabled" /t REG_DWORD /d "0" /f
...
:c2
echo Revert CPU Config
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerThrottling" /v "PowerThrottlingOff" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "HighPerformance" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "HighestPerformance" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "MaximumPerformancePercent" /t REG_DWORD /d "100" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "MinimumThrottlePercent" /t REG_DWORD /d "100" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "MaximumThrottlePercent" /t REG_DWORD /d "100" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "Cstates" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power" /v "PERFBOOSTMODE" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\3b04d4fd-1cc7-4f23-ab1c-d1337819c4bb\DefaultPowerSchemeValues\381b4222-f694-41f0-9685-ff5bb260df2e" /v "ACSettingIndex" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\3b04d4fd-1cc7-4f23-ab1c-d1337819c4bb\DefaultPowerSchemeValues\381b4222-f694-41f0-9685-ff5bb260df2e" /v "DCSettingIndex" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubDelay" /t REG_DWORD /d "10" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubInterval" /t REG_DWORD /d "10" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubPower" /t REG_DWORD /d "50" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubThreshold" /t REG_DWORD /d "10" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubValue" /t REG_DWORD /d "10" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "CpuIdleScrubValueEnabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Processor" /v "AllowPepPerfStates" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v "DistributeTimers" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v "DisableTsx" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power" /v "CoalescingTimerInterval" /t REG_DWORD /d "1000" /f
...
echo.
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Disable everything in Playback and recording EXCEPT YOUR HEADPHONES AND MIC', 'SETT Tweaking Utility', 'Ok' , [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
...
cls
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('select adjust for best performanceAnd select Show Thumbnails Instead of icans, smooth edges on screen fonts and press apply', 'SETT Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
...
cls
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE IF YOU HAVE AN NVIDIA GPU', 'SETT Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
cls
...
echo.
echo.                                         %p%[3]%w% Nvidia Profile Inspector      %p%[4]%w% Enable Msi Mode and More
echo.
echo.                                         %p%[5]%w% Disable TDR                   %p%[6]%w% Latency Tolernace
echo.
echo.                                         %p%[7]%w% Disable HDCP                  %p%[8]%w% Optimize PowerMizer 
echo. 
echo.                                         %p%[9]%w% Advanced Driver Debloat       %p%[10]%w% Advanced tweaks    
echo.
echo.
echo.                                                                Type "X" to go back to menu
echo.
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrDelay" /t REG_DWORD /d "8" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrDdiDelay" /t REG_DWORD /d "10" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrDebugMode" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrLimitCount" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "TdrLimitTime" /t REG_DWORD /d "8" /f
...
cls
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE IF YOU HAVE AN AMD GPU', 'SETT Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
...
:intelgpu
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE IF YOU HAVE AN INTEL GPU', 'SETT Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
cls
...
Reg.exe add "HKLM\System\CurrentControlSet\Enum\%%i\Device Parameters\Interrupt Management\Affinity Policy" /v "DevicePriority" /t REG_DWORD /d 3 /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\nvlddmkm\Parameters" /v "ThreadPriority" /t REG_DWORD /d "24" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\NDIS\Parameters" /v "ThreadPriority" /t REG_DWORD /d "13" /f
...
echo.
echo.                                         %p%[3]%w% Kernel Tweaks             %p%[4]%w% Speed up start time 
echo.
...
echo.
echo.                                         %p%[19]%w% Harden SMB               %p%[20]%w% Disable DMA remapping
echo.
echo.                                         %p%[22]%w% Force Montior HZ 
echo.
echo.                                                 
echo.  
echo.
...
if /i %input% == 3 goto Kernel
if /i %input% == 4 goto god22
...
if /i %input% == 20 goto god21

if /i %input% == 22 goto god23
if /i %input% == X cls & goto menu
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "RmGspcMinFtuS" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "RmGspcPerioduS" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "RMLpwrEiIdleThresholdUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "RMLpwrGrIdleThresholdUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "RMLpwrGrRgIdleThresholdUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "RMLpwrMsIdleThresholdUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "VRDirectFlipDPCDelayUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "VRDirectFlipTimingMarginUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "VRDirectJITFlipMsHybridFlipDelayUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "vrrCursorMarginUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "vrrDeflickerMarginUs" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "vrrDeflickerMaxUs" /t REG_DWORD /d "5" /f
echo.
echo.
echo.
echo.                                              %b%╔═════════════════════════════════════════════════════════════╗
...
echo.
echo.
echo.                                          %p%[1]%w% Optimize MMCSS                   %p%[2]%w% Advanced Priority Tweaks
echo.
...
echo.
echo.                                                        %p%[11]%w% Additional Service Priorities   
...
echo.
echo.
echo.                                    %p%[1]%w% Advanced CSGO 2 Priority     %p%[2]%w% Advanced Valorant Priority
echo.
echo. 
echo.                                                         Press "X" to go back to menu
echo.
...
:cs2
:: Prioridade de CPU e GPU - performance sem riscos
...
:: Evita throttling de energia (Power Throttling Off)
...
:: QoS para priorização de pacotes de rede (marca DSCP 46 – EF – alta prioridade)
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "Application Name" /t REG_SZ /d "cs2.exe" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "Version" /t REG_SZ /d "1.0" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "Protocol" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "Local Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "Remote Port" /t REG_SZ /d "*" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "DSCP Value" /t REG_SZ /d "46" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\QoS\cs2.exe" /v "Throttle Rate" /t REG_SZ /d "-1" /f
echo.
echo.
echo.
echo.                                              %b%╔═════════════════════════════════════════════════════════════╗
...
echo.
echo.
echo.                                         %p%[1]%w% Set SETT Power Plan                    %p%[2]%w% Additional Power Tweaks
echo.
...
cls
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('ONLY DO THESE ON ETHERNET, WIFI TWEAKS COMING IN 1.0', 'SETT Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
echo
echo.
echo.
